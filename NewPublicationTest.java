...
public class NewPublicationTest {
    WebDriver driver;
    WebDriverWait wait;
    @BeforeTest
    private void init() {
        ...
        driver.get("http://127.0.0.1:8000/publications/create"); // Add your actual login URL here
    ...
    public void newMonograph() throws InterruptedException{
        ...
        driver.findElement(By.name("content")).sendKeys("This is the content of the sample publication.");
        ...
        // Handle dropdowns
        Select languageSelect = new Select(driver.findElement(By.name("category")));
        languageSelect.selectByValue("Artikel");
