...
public class WorkHourCoorParaf {
    WebDriver driver;
    WebDriverWait wait;
    @BeforeTest
    private void init() {
        ...
        driver.get("http://127.0.0.1:8000/nota_dinas"); // Add your actual login URL here
    ...
    public void DelPublication() throws InterruptedException{
        ...
        driver.findElement(By.id("outsideWorkingHoursMessage"));
