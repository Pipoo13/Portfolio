...
public class NewInstitution {
    ...
    private void init() {
        ...
        driver.get("http://127.0.0.1:8000/institutions/create"); // Add your actual login URL here
    ...
    @Test
    public void NewInstitutionadd() throws InterruptedException{
        // Fill the title field
        driver.findElement(By.name("name")).sendKeys("Dinas Komunikasi Informasi Statistik dan Persandian");
